...
void STrackerImageViewer::DrawSelectionBoxes(FSlateWindowElementList& OutDrawElements, int32 InLayerId,	const FGeometry& AllottedGeometry) const
{
	...
	if(bDrawSelection)
	{
		...
		FSlateDrawElement::MakeBox(OutDrawElements, InLayerId, BoxGeometry, FEditorStyle::GetBrush(BorderName), ESlateDrawEffect::None, FLinearColor(1.0f, 1.0f, 1.0f, 0.2f));
	}
}
